package com.gdu.sporters.userSupport.aop;
...
@Component
@Aspect
public class RequireLoginAspectUserSupport {
	
	@Pointcut("execution(* com.gdu.sporters.userSupport.controller.*Controller.requiredLogin_*(..))")
