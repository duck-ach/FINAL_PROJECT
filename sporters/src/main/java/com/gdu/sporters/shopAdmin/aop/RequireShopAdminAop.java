package com.gdu.sporters.shopAdmin.aop;
...
public class RequireShopAdminAop {
	
	@Pointcut("execution(* com.gdu.sporters.shopAdmin.controller.*Controller.requiredAdmin_*(..))")	
