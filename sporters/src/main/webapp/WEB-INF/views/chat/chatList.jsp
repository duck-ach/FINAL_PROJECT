...
.buttons.purple {box-shadow:0px 4px 0px #b6b6f3; margin-right: 30px;}
...
<section class="wrap"><!-- 기본틀 1 -->
	<section class="content_leyout_section"><!-- 기본틀 2 -->
		...
		<div> <!-- 여기부터 각자 내용 넣기 시작 -->
			...
			<div id="all_wrap">
				<div id="title_wrap">
					<div class="mapage_div" style="font-size: 32px; font-weight: bold; text-align: center; margin-bottom: 40px; margin-right: 169px;"> 채팅하기 </div>
				</div>
				<div class="div_btns">
