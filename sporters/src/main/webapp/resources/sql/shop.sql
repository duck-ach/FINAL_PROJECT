...
DROP SEQUENCE PROD_TN_SEQ;

CREATE SEQUENCE PROD_TN_SEQ;
...
CREATE TABLE PROD_THUMBNAIL(
    TN_NO NUMBER NOT NULL,
    PROD_NO NUMBER,
    TN_PATH VARCHAR2(300 BYTE),
    TN_ORIGIN VARCHAR2(300 BYTE),
    TN_FILESYSTEM VARCHAR2(42 BYTE),
    IS_THUMBNAIL NUMBER(1),
    PRIMARY KEY(TN_NO),
    FOREIGN KEY(PROD_NO) REFERENCES PRODUCT(PROD_NO) ON DELETE CASCADE
);

INSERT INTO PROD_CATEGORY (PROD_CATEGORY_NO, PROD_CATEGORY_NAME)
    VALUES (PROD_CATEGORY_SEQ.NEXTVAL, '음식');
INSERT INTO PROD_CATEGORY (PROD_CATEGORY_NO, PROD_CATEGORY_NAME)
    VALUES (PROD_CATEGORY_SEQ.NEXTVAL, '의류');
INSERT INTO PROD_CATEGORY (PROD_CATEGORY_NO, PROD_CATEGORY_NAME)
    VALUES (PROD_CATEGORY_SEQ.NEXTVAL, '물건');
COMMIT;
