...
CREATE TABLE QNA (
   ...
   QNA_CONTENT   VARCHAR(20000)      NOT NULL,
   QNA_CREATE_DATE   DATE      NOT NULL,
   STATE      INT      NOT NULL,
   DEPTH      INT      NOT NULL,
   GROUP_NO   INT      NOT NULL,
   FAQ_STATE   INT      NOT NULL,
PRIMARY KEY(QNA_NO),
...
CREATE TABLE QNA_COMM (
   ...
   QNA_NO      		INT,
   QNA_COMM_CONTENT   VARCHAR(20000)      NOT NULL,
...
INSERT INTO USERS
   (ID, NICKNAME, PW, NAME, GENDER, EMAIL, MOBILE, BIRTHYEAR, BIRTHMONTH, BIRTHDAY, POSTCODE, ROAD_ADDRESS, JIBUN_ADDRESS, DETAIL_ADDRESS, AGREE_CODE, SNS_TYPE, JOIN_DATE, INFO_MODIFY_DATE, PW_MODIFY_DATE, SESSION_ID, SESSION_LIMIT_DATE, BANNED_STATE) 
VALUES
   ('user99', '휴면', ' FFE1ABD1A 8215353C233D6E0 9613E95EEC4253832A761AF28FF37AC5A15 C', '휴면', 'M', 'user01@gmail.com', '01011111111', '1958', '01', '01', NULL, NULL, NULL, NULL, 0, NULL, DATE('20201111'), NULL, NULL, NULL, NULL, 0);
