...
INSERT INTO USERS
	(USER_NO, ID, NICKNAME, PW, NAME, GENDER, EMAIL, MOBILE, BIRTHYEAR, BIRTHMONTH, BIRTHDAY, POSTCODE, ROAD_ADDRESS, JIBUN_ADDRESS, DETAIL_ADDRESS, AGREE_CODE, SNS_TYPE, JOIN_DATE, INFO_MODIFY_DATE, PW_MODIFY_DATE, SESSION_ID, SESSION_LIMIT_DATE, BANNED_STATE) 
VALUES
	(USERS_SEQ.NEXTVAL, 'user99', '휴면', ' FFE1ABD1A 8215353C233D6E0 9613E95EEC4253832A761AF28FF37AC5A15 C', '휴면', 'M', 'user01@gmail.com', '01011111111', '1958', '01', '01', NULL, NULL, NULL, NULL, 0, NULL, TO_DATE('20201111', 'YYYYMMDD'), NULL, NULL, NULL, NULL, 0);
COMMIT;