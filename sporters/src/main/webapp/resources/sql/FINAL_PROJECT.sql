...
INSERT INTO ORDERS(USER_NO, CART_NO, PAYMENT, NAME, MOBILE, POSTCODE, LOAD_ADDRESS, JIBUN_ADDRESS, DETAIL_ADDRESS, ORDER_DATE, ORDER_STATE, PRICE_ALL)
	VALUES(1, null, '1', '수령자', '01023232323', '12341', '눈길 234', '눈동네 134번지', '사슴아파트 2002호', NOW(), '결제완료', '134000');
INSERT INTO ORDERS(USER_NO, CART_NO, PAYMENT, NAME, MOBILE, POSTCODE, LOAD_ADDRESS, JIBUN_ADDRESS, DETAIL_ADDRESS, ORDER_DATE, ORDER_STATE, PRICE_ALL)
	VALUES(2, null, '1', '산타', '01023232323', '98731', '신림길 124', '산타마을 134번지', '산타아파트 232호', NOW(), '배송중', '94000');